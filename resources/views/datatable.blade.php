            ...
            @if($c->isSearchable())
                <div style="width: 300px">
                    <input
                        ...
                        type="search"
                        name="search"
                        class="block w-full rounded-md py-1 px-2 border border-slate-800 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
